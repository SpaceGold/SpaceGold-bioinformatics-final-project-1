...
prevalence_plot <- prevalence_data %>%
  ...
  labs(title = "Prevalence of SARS-CoV-2 antibodies across Manaus and São Paulo
       ...
       # TODO: ADAM FIX LEGEND
  # theme(legend.title = "State", legend.) +
...
mortality_plot <- ggplot(mortality_data, aes(x = age, y = mortality)) +
  geom_col() +
  labs(title = "Excess mortality in Manaus by age and gender",
         x = "Age", y = "Deaths") +
  theme_clean()
...
**Figure**: Excess mortality, the number of atypical deaths, was highest in Manaus males and older patients, March 2020 through June 2020.
