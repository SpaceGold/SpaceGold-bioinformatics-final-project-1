...
mortality_plot_m <- ggplot(data = mortality_data_m,
                           aes(x = age, y = value,
                               color = mortality)) +
  geom_col(aes(fill = mortality, labels = c("Excess mortality male",
...
**Figure 6**: The majority of single nucleotide polymorphism mutations among Brazilian sample genomes were substitutions of thymine with guanine.
