...
pkg citations; See methods section of https://elifesciences.org/articles/61981
...
Excess mortality in 50-55 year old male patients reached a maximum of 126 deaths/1000, 1.30 times their expected mortality of 99 deaths/1000, as well as 2.49 the excess mortality of female patients of the same age at 54.8 deaths/1000 (\textcolor{red}{TODO: Figure number}; )
...
**Figure**: Excess mortality, unexpected deaths of any cause, reached a maximum of 2.49 times the expected mortality in female patients.
...
**Figure**: Excess mortality in male patients reached a maximum of more than double their expected mortality, as well as double the excess mortality of female patients.

```{r genetic-plot}
# assess quality of VCF data using a plot from https://knausb.github.io/vcfR_documentation/visualization_1.html

# Input the files.
vcf <- read.vcfR("data/11_vcf_output_for_R/SRR12620259_1.trim.fastq.bwa-output.sorted.bam.raw.bcf.final-variants.vcf", verbose = FALSE)
dna <- ape::read.dna("/data/sars_vcf_analysis/02_genome_reference/sars_refgenome.fasta",
                     format = "fasta")
gff <- read.table("/data/sars_vcf_analysis/02_genome_reference/sars_refgenome_annotation.gff",
                  sep="\t", quote="")
